...
(alibi VARCHAR2(500), etat VARCHAR2(50));
/
...
(id INTEGER, etat VARCHAR2(50), enqueteurs bdm_enqueteurs_type, suspects bdm_suspects_type, 
...
(id INTEGER, fait VARCHAR2(50), lieu VARCHAR2(50), date DATE, enqueteC REF bdm_enquete_type, 
victimes bdm_victimes_type);
/

CREATE TYPE bdm_temoignage_type AS OBJECT 
(id INTEGER, date DATE, contenu VARCHAR2(1000), personneT REF bdm_personne_type, crimeT REF bdm_crime_type);
/
